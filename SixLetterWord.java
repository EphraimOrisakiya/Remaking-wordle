//Six Letter Word  class to be used in the Wordle program. This class extends the Word class. And implements the abstract methods.
import java.util.*;
import java.util.ArrayList;
public class SixLetterWord extends Word{
  // Constructor
  private static int length = 6;

  public SixLetterWord(String[] wordList) {
    super(wordList);
    super.setLength(6);
  }
