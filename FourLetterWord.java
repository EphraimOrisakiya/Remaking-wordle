...
//Four Letter Word  class to be used in the Wordle program. This class extends the Word class. And implements the abstract methods.
import java.util.*;
import java.util.ArrayList;
public class FourLetterWord extends Word{
  // Constructor
  private static int length = 4;
  public FourLetterWord (String [] wordList){
    super(wordList);
    super.setLength(4);
  }
